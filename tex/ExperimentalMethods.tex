...
\begin{figure}[h]
	...
	\caption{An illustration of the setup. Det1-Det4 are placed around the target, facing the target which is located at the center of the coordinate system. DetU are above the target, and DetD are below the target. Behind each detector is a PAD, with the exception of Det1, who's PAD was defect. }
